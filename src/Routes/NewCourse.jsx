  ...
  return (
    <>
      <div className="flex justify-center items-center mb-5">
        <Form className="bg-white p-6 rounded shadow-md w-full max-w-sm" method="POST">
          <h2 className="text-2xl mb-4">دوره جدید</h2>
          <div className="mb-4">
            <label className="block text-gray-700">اسم</label>
            <input type="text" className="w-full px-3 py-2 border rounded" name="name"/>
          </div>
          <div className="mb-4">
            <label className="block text-gray-700">نوع</label>
            <select className="w-full px-3 py-2 border rounded"  name="type">
              {
                loaderData.data.map( e=> <option key={e.id} value={e.id}>{e.name}</option> )
              }
            </select>
          </div>
          <div className="mb-4">
            <label className="block text-gray-700">آپلود تصویر</label>
            <input type="file" className="w-full px-3 py-2 border rounded" name="banner"/>
          </div>
          <div className="mb-4">
            <label className="block text-gray-700">نام استاد</label>
            <input type="text" className="w-full px-3 py-2 border rounded" name="teacher"/>
          </div>
          <div className="mb-4">
            <label className="block text-gray-700">نیاز به ثبت نام</label>
            <select className="w-full px-3 py-2 border rounded" name="needSignUp">
          ...
          <div className="mb-4">
            ...
            <textarea className="w-full px-3 py-2 border rounded" name="schedule"></textarea>
          </div>
          <div className="mb-4">
            <label className="block text-gray-700">مکان</label>
            <input type="text" className="w-full px-3 py-2 border rounded" name="location"/>
          </div>
          <div className="mb-4">
          <label className="block text-gray-700">تعداد جلسات</label>
          <input type="number" className="w-full px-3 py-2 border rounded" name="sessions"/>
        </div>
        <div className="mb-4">
          <label className="block text-gray-700">ساعت</label>
          <input type="number" className="w-full px-3 py-2 border rounded" name="hour"/>
        </div>
        <div className="mb-4">
          <label className="block text-gray-700">دقیقه</label>
          <input type="number" className="w-full px-3 py-2 border rounded" name="minute" />
        </div>
        <div className="mb-4">
